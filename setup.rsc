...
/interface wifi set [ find default-name=wifi1 ] channel.band=5ghz-ax .reselect-interval=1h..2h .width=20/40/80mhz configuration.tx-power=10 security.authentication-types=wpa3-psk .wps=disable;
